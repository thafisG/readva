...
public class ReadingActivityController {
    ...
    public ReadingActivityController(ReadingActivityService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<ReadingActivityResponse> record(
            @PathVariable UUID readerId, @Valid @RequestBody CreateReadingActivityRequest request) {
    ...
    @GetMapping
    public List<ReadingActivityResponse> list(@PathVariable UUID readerId) {
